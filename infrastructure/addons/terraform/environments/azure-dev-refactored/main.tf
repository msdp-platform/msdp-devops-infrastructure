...
module "prometheus_stack" {
  ...
  chart_version = module.versions.chart_versions.prometheus_stack
  
  # Grafana configuration
  grafana_admin_password = local.plugins.prometheus_stack.grafana.admin_password
  grafana_domain        = local.plugins.prometheus_stack.grafana.domain
  prometheus_domain     = local.plugins.prometheus_stack.prometheus.domain
